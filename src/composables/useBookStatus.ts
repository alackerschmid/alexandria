...
export const STATUS_META: Record<ReadStatus, StatusMeta> = {
  ...
  read: {
    textClass: "text-status-read",
    dotClass: "bg-status-read",
    activeClass: "text-status-read",
    icon: "mdi-check-circle-outline",
    color: "var(--color-status-read)",
    tint: "color-mix(in srgb, var(--color-status-read) 10%, transparent)",
    themeColor: "rgb(var(--v-theme-success))",
  },
  dnf: {
    textClass: "text-status-dnf",
    dotClass: "bg-status-dnf",
    activeClass: "text-status-dnf",
    icon: "mdi-book-remove-outline",
    color: "var(--color-status-dnf)",
    tint: "color-mix(in srgb, var(--color-status-dnf) 10%, transparent)",
